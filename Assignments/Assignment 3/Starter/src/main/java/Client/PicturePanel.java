 ...
 *
 * Methods of interest ---------------------- newGame(int dimension) - Reset the board and set grid size to dimension x dimension
...
public class PicturePanel extends JPanel {
    ...
    /**
     * Creates a new game NOTE: Will reset all state and clear board
     *
