...
public class TiledRebusGameUDPServer {
    ...
    private static void play(CustomProtocol playerResponse, DatagramPacket packet) throws IOException {
        ...
        if (playerLost) {
            ...
            serverResponseToPlayerPayload = new Payload(null, "Terribly sorry, but you have lost the game.", false, true, false);
            ...
            String message = (answeredCorrectly ? "You answered correctly!" : String.format("Terribly sorry but you've answered incorrectly %d times"
